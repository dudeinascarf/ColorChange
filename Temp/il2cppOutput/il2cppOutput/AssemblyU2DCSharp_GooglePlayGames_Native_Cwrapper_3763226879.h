...
struct  SnapshotConflictPolicy_t3763226879 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(SnapshotConflictPolicy_t3763226879, ___value___1)); }
