...
struct  SnapshotManager_t2359319983  : public Il2CppObject
{
public:
...
public:
	inline static int32_t get_offset_of_mServices_0() { return static_cast<int32_t>(offsetof(SnapshotManager_t2359319983, ___mServices_0)); }
