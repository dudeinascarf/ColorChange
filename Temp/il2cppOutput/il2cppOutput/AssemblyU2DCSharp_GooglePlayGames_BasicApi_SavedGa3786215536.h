...
struct  SavedGameRequestStatus_t3786215536 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(SavedGameRequestStatus_t3786215536, ___value___1)); }
