...
struct  SnapshotOpenStatus_t1179182268 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(SnapshotOpenStatus_t1179182268, ___value___1)); }
