...
struct  ConflictResolutionStrategy_t2415333593 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(ConflictResolutionStrategy_t2415333593, ___value___1)); }
