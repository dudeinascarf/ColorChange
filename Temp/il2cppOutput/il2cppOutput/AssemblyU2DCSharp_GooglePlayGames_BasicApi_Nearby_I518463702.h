...
struct  InitializationStatus_t518463702 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(InitializationStatus_t518463702, ___value___1)); }
