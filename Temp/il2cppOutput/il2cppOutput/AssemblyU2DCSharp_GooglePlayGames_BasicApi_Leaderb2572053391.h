...
struct  LeaderboardStart_t2572053391 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(LeaderboardStart_t2572053391, ___value___1)); }
