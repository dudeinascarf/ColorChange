...
struct  MultiplayerStatus_t1534922096 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(MultiplayerStatus_t1534922096, ___value___1)); }
