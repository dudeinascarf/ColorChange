...
struct  EventManager_t2071886271  : public Il2CppObject
{
public:
...
public:
	inline static int32_t get_offset_of_mServices_0() { return static_cast<int32_t>(offsetof(EventManager_t2071886271, ___mServices_0)); }
