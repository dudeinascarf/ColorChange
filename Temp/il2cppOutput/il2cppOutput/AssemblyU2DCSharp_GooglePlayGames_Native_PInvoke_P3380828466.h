...
struct  PlayerManager_t3380828466  : public Il2CppObject
{
public:
...
public:
	inline static int32_t get_offset_of_mGameServices_0() { return static_cast<int32_t>(offsetof(PlayerManager_t3380828466, ___mGameServices_0)); }
