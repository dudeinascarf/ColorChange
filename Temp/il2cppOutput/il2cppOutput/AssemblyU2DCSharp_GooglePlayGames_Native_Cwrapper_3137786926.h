...
struct  ParticipantStatus_t3137786926 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(ParticipantStatus_t3137786926, ___value___1)); }
