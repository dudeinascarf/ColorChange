...
struct  AchievementState_t1457931865 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(AchievementState_t1457931865, ___value___1)); }
