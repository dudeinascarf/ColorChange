...
struct  CommonStatusCodes_t671203459 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(CommonStatusCodes_t671203459, ___value___1)); }
