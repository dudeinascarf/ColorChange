...
struct  EventVisibility_t4260498101 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(EventVisibility_t4260498101, ___value___1)); }
