...
struct  StatsManager_t4261398554  : public Il2CppObject
{
public:
...
public:
	inline static int32_t get_offset_of_mServices_0() { return static_cast<int32_t>(offsetof(StatsManager_t4261398554, ___mServices_0)); }
